        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              // Same-origin /api always allowed via 'self'; in dev allow localhost/127.0.0.1 for hot reload and tooling
              `connect-src 'self'${process.env.NODE_ENV === 'development' ? ' http://localhost:* http://127.0.0.1:* ws://localhost:* ws://127.0.0.1:*' : ''}`,
